...
import { LayoutDashboard, RefreshCw, ChevronDown, ChevronUp, Search, TimerReset } from 'lucide-react';
									...
									{filteredRequests.map((req) => {
										...
										return (
											<React.Fragment key={req.id}>
												<tr className={`border-b border-[#E8E8E8] text-[#2C2C2C] hover:bg-[#FAFAFA] ${updatingId === req.id ? 'opacity-60' : ''}`}>
													...
													<td className="px-3 py-2">
														...
														>
															{isExpanded ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}Лента
														</button>
													</td>
												</tr>

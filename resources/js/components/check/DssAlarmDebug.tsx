...
import { AlertTriangle, ArrowRightLeft, Camera, CheckCircle2, Clock3, Loader2, LogOut, MapPin, Radio, RefreshCw, Search, ShieldCheck, Truck, Wifi, WifiOff, XCircle, Package, KeyRound, Scale } from 'lucide-react';
...
import { bindDssAlarmConnectionDebug, subscribeToPublicDssUnknownVehicleDetected } from '@/lib/dss-alarms';
...
export default function DssAlarmDebug() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToPublicDssUnknownVehicleDetected(() => { setLastSignalAt(new Date().toISOString()); void loadSnapshot(); });

...
class UpdatePlantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', 'nullable', Rule::in(['active', 'alive', 'needs_care', 'written_off'])],
            ...
            'plant_type' => ['sometimes', 'nullable', 'string', 'max:255'],
            'height_value' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'height_unit' => ['sometimes', 'nullable', 'string', 'max:20'],
            'trunk_diameter_value' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'trunk_diameter_unit' => ['sometimes', 'nullable', 'string', 'max:20'],
            'condition_text' => ['sometimes', 'nullable', 'string', 'max:255'],
            'gps_coordinates' => ['sometimes', 'nullable', 'string', 'max:255'],
            'last_inspection_date' => ['sometimes', 'nullable', 'date'],
            'condition_notes' => ['sometimes', 'nullable', 'string'],
            'acquisition_date' => ['sometimes', 'nullable', 'date'],
            'last_inventory_date' => ['sometimes', 'nullable', 'date'],
